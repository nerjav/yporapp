                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'precio_unitario'">{{ trans('admin.producto.columns.precio_unitario') }}</th>
                                        <th is='sortable' :column="'stock_actual'">{{ trans('admin.producto.columns.stock_actual') }}</th>
