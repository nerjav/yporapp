...
class FillPermissionsForMetodosDePago extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMetodosDePago constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.metodos-de-pago',
            'admin.metodos-de-pago.index',
            'admin.metodos-de-pago.create',
            'admin.metodos-de-pago.show',
            'admin.metodos-de-pago.edit',
            'admin.metodos-de-pago.delete',
            'admin.metodos-de-pago.bulk-delete',
        ]);
