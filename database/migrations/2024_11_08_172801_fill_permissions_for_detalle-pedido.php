...
class FillPermissionsForDetallePedido extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.detalle-pedido.index',
            'admin.detalle-pedido.create',
            'admin.detalle-pedido.show',
            'admin.detalle-pedido.edit',
            'admin.detalle-pedido.delete',
            'admin.detalle-pedido.bulk-delete',
        ]);
