...
class FillPermissionsForTipoDeCliente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipoDeCliente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipo-de-cliente',
            'admin.tipo-de-cliente.index',
            'admin.tipo-de-cliente.create',
            'admin.tipo-de-cliente.show',
            'admin.tipo-de-cliente.edit',
            'admin.tipo-de-cliente.delete',
            'admin.tipo-de-cliente.bulk-delete',
        ]);
