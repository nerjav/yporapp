...
class FillPermissionsForEstadosPedido extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstadosPedido constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.estados-pedido',
            'admin.estados-pedido.index',
            'admin.estados-pedido.create',
            'admin.estados-pedido.show',
            'admin.estados-pedido.edit',
            'admin.estados-pedido.delete',
            'admin.estados-pedido.bulk-delete',
        ]);
