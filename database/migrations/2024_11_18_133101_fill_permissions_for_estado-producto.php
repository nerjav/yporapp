...
class FillPermissionsForEstadoProducto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstadoProducto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.estado-producto.index',
            'admin.estado-producto.create',
            'admin.estado-producto.show',
            'admin.estado-producto.edit',
            'admin.estado-producto.delete',
            'admin.estado-producto.bulk-delete',
        ]);
