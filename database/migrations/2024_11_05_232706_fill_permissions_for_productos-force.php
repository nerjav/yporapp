...
class FillPermissionsForProductosForce extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductosForce constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.productos-force',
            'admin.productos-force.index',
            'admin.productos-force.create',
            'admin.productos-force.show',
            'admin.productos-force.edit',
            'admin.productos-force.delete',
            'admin.productos-force.bulk-delete',
        ]);
